                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription asChild>
                            <div className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                                <p>• Click an empty slot to create a task</p>
                                <p>
                                    • Drag across slots to create a multi-slot
                                    task
                                </p>
                                <p>• Click a task to edit in the sidebar</p>
                                <p>
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription asChild>
                            <ul className="list-disc ml-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
                                <li>
                                    <span className="font-medium">C</span>: Open
                                    create task
                                </li>
                                <li>
                                ...
                                <li>
                                    <span className="font-medium">T</span>: Jump
                                    to today
                                </li>
                                <li>
